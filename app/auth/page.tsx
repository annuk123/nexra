...
//         <p className="text-neutral-500 text-sm mt-2">Continue thinking.</p>
//       </div>
...
export default function NexraAuthPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#09090B] text-white">
      ...
      {/* Soft glow */}
      <div className="absolute left-[-120px] top-[-120px] h-[300px] w-[300px] rounded-full bg-white/[0.03] blur-3xl" />
      <div className="absolute bottom-[-120px] right-[-120px] h-[300px] w-[300px] rounded-full bg-white/[0.02] blur-3xl" />
