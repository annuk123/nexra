    ...
    >
      ...
      Back to home
        ...
        <div className="grid w-full items-center gap-16 lg:grid-cols-[1fr_480px]">
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-100 transition cursor-pointer"
        >
         ...
         <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-neutral-800 text-white text-sm font-medium hover:bg-neutral-700 transition border border-neutral-700 cursor-pointer"
        >
